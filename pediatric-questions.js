...
window.QUESTIONS = [
  ...
  // --- Pediatric-specific question: not present in the adult questionnaire.
  // "ageRange" is a free-text criterion (pass-through from the Excel file)
  // — add an "ageRange" row in data/pediatric.xlsx to use it.
